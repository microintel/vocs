...
function serT() {
  ...
  let filtered = newDa.filter(x => {
    let w = (typeof x === "object" ? JSON.stringify(x) : x).toLowerCase();
    return w.includes(val);
  });
  appendWords(filtered, "www");
}
    ...
    doc.setFontSize(14);
    doc.text("VOC", 105, 30, null, null, "center");
